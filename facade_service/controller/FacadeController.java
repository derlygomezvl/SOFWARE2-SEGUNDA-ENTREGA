...
//    @PostMapping(path = "/registrar-docente")
//    public ResponseEntity<String> registrarDocente(DocenteDTO prmDocente) {
//        ATR_LOGGER.info("API: POST /facade/registrar-docente -> {}", prmDocente.getAtrNombre());
//        boolean objOk = atrSistemaFacade.registrarDocente(prmDocente);
//        if (objOk) {
//            return ResponseEntity.ok("Docente registrado correctamente (fachada).");
//        } else {
//            return ResponseEntity.status(502).body("Error al registrar docente en servicios externos.");
//        }
//    }
